...
<div class="page-header theme-bg-dark py-5 text-center position-relative">
	...
	<div class="container">
		<h1 class="page-heading single-col-max mx-auto">神经教育学大数据OJ子库</h1>
		<div class="page-intro single-col-max mx-auto">支撑基于在线测评系统的虚拟行为分析</div>
		<div class="main-search-box pt-3 d-block mx-auto">
			 <form class="search-form w-100" action="search.php" method="post">
				<input type="text" placeholder="检索数据" name="search" class="form-control search-input">
				...
				<div class="col-12 col-lg-4 py-3">
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title mb-3">
								<span class="theme-icon-holder card-icon-holder mr-2">
									<svg class="svg-inline--fa fa-book-reader fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="book-reader" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M352 96c0-53.02-42.98-96-96-96s-96 42.98-96 96 42.98 96 96 96 96-42.98 96-96zM233.59 241.1c-59.33-36.32-155.43-46.3-203.79-49.05C13.55 191.13 0 203.51 0 219.14v222.8c0 14.33 11.59 26.28 26.49 27.05 43.66 2.29 131.99 10.68 193.04 41.43 9.37 4.72 20.48-1.71 20.48-11.87V252.56c-.01-4.67-2.32-8.95-6.42-11.46zm248.61-49.05c-48.35 2.74-144.46 12.73-203.78 49.05-4.1 2.51-6.41 6.96-6.41 11.63v245.79c0 10.19 11.14 16.63 20.54 11.9 61.04-30.72 149.32-39.11 192.97-41.4 14.9-.78 26.49-12.73 26.49-27.06V219.14c-.01-15.63-13.56-28.01-29.81-27.09z"></path></svg><!-- <i class="fas fa-book-reader"></i> -->
								</span><!--//card-icon-holder-->
					...
					<div class="card shadow-sm">
						<div class="card-body">
							<h5 class="card-title mb-3">
								<span class="theme-icon-holder card-icon-holder mr-2">
									<svg class="svg-inline--fa fa-tablet-alt fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tablet-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M400 0H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zM224 480c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm176-108c0 6.6-5.4 12-12 12H60c-6.6 0-12-5.4-12-12V60c0-6.6 5.4-12 12-12h328c6.6 0 12 5.4 12 12v312z"></path></svg><!-- <i class="fas fa-tablet-alt"></i> -->
								</span><!--//card-icon-holder-->
								<span class="card-title-text">联系方式</span>
							</h5>
							<div class="card-text">本数据库及其前端、检索算法皆由东南大学夏小俊课题组设计并实现，数据标准亦是由此团队制定。欢迎国内同行及对开发和教育数据挖掘感兴趣的学生联系。</div>
							<a class="card-link-mask" href="http://www.bmeonline.cn/%e5%85%b3%e4%ba%8e%e6%88%91%e4%bb%ac/"></a>
						</div><!--//card-body-->
					</div><!--//card-->
				</div><!--//col-->
			</div><!--//row-->
...
<section class="cta-section text-center py-5 theme-bg-dark position-relative">
	...
	<div class="theme-bg-shapes-left"></div>
	<div class="container">
		<h3 class="mb-2 text-white mb-3">神经教育学大数据中心</h3>
		<div class="section-intro text-white mb-3 single-col-max mx-auto">神经教育学以神经科学、认知科学、心理学、学习科学、脑科学等学科的成果为理论基础，与当今诸多先进技术和相关科技基础设施联系紧密，此视角下的实证研究符合“采集-分析-应用”（3A）的研究框架。神经教育学大数据中心将瞄准神经教育学学科发展的国际前沿，直面教育的瓶颈和难点问题，努力建成具有世界一流水平的面向神经教育学研究的生物医学大数据中心。</div>
		<div class="pt-3 text-center">
			<a class="btn btn-light" href="https://rcls.seu.edu.cn/">了解更多<svg class="svg-inline--fa fa-arrow-alt-circle-right fa-w-16 ml-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-alt-circle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 8c137 0 248 111 248 248S393 504 256 504 8 393 8 256 119 8 256 8zM140 300h116v70.9c0 10.7 13 16.1 20.5 8.5l114.3-114.9c4.7-4.7 4.7-12.2 0-16.9l-114.3-115c-7.6-7.6-20.5-2.2-20.5 8.5V212H140c-6.6 0-12 5.4-12 12v64c0 6.6 5.4 12 12 12z"></path></svg><!-- <i class="fas fa-arrow-alt-circle-right ml-2"></i> --></a>
		</div>
	</div>
</section><!--//cta-section-->
